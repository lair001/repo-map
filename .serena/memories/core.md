...
- Current roadmap: Phase 3 shell extractor is underway. Current discovery emits simple `shell.command` and static `shell.source` observations; shell facts should remain deterministic and evidence-backed.
